...
class RichCollectionBase(CollectionBase):
    ...
    def copy(
        self,
        source: str | CollectionItem,
        target_path: str,
        source_collection: RichCollectionBase | None = None,
        overwrite: bool = False,
    ) -> None: ...
    def rename(
        self,
...
class Collection(RichCollectionBase):
    def __init__(
        self,
        manifest_locator_or_text: str | None = None,
        api_client: arvados.api.ThreadSafeAPIClient | None = None,
        keep_client: KeepClient | None = None,
        num_retries: int = 10,
        parent: Collection | None = None,
        apiconfig: Mapping[str, str] | None = None,
        replication_desired: int | None = None,
        storage_classes_desired: list[str] | None = None,
        put_threads: int | None = None,
    ) -> None: ...
    ...
    def known_past_version(
        self, modified_at_and_portable_data_hash: tuple[str | None, str | None]
    ) -> bool: ...
    def update(
        self, other: Collection | None = None, num_retries: int | None = None
    ) -> None: ...
