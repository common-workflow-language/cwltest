...
class ApiClientAuthorizations:
    def create(
        self,
        *,
        body: dict[Literal["api_client_authorization"], ApiClientAuthorization],
        cluster_id: str | None = None,
        ensure_unique_name: bool = False,
        select: List[str] | None = None,
    ) -> ArvadosAPIRequest[ApiClientAuthorization]: ...
    def create_system_auth(
        self, *, scopes: List[str] = ["all"]
    ) -> ArvadosAPIRequest[ApiClientAuthorization]: ...
    ...
    def get(
        self, *, uuid: str, select: List[str] | None = None
    ) -> ArvadosAPIRequest[ApiClientAuthorization]: ...
    def list(
        self,
        *,
        bypass_federation: bool = False,
        cluster_id: str | None = None,
        count: str = "exact",
        distinct: bool = False,
    ...
    ) -> ArvadosAPIRequest[ApiClientAuthorizationList]: ...
    def update(
        self,
        *,
        body: dict[Literal["api_client_authorization"], ApiClientAuthorization],
...
class AuthorizedKeys:
    def create(
        self,
        *,
        body: dict[Literal["authorized_key"], AuthorizedKey],
        cluster_id: str | None = None,
        ensure_unique_name: bool = False,
        select: List[str] | None = None,
    ) -> ArvadosAPIRequest[AuthorizedKey]: ...
    ...
    def list(
        ...
        *,
        ...
        select: List[str] | None = None,
        where: dict[str, Any] | None = None,
    ) -> ArvadosAPIRequest[AuthorizedKeyList]: ...
    def update(
        self,
        *,
        body: dict[Literal["authorized_key"], AuthorizedKey],
...
class Collections:
    def create(
        self,
        *,
        body: dict[Literal["collection"], Collection],
        cluster_id: str | None = None,
        ensure_unique_name: bool = False,
        replace_files: dict[str, Any] | None = None,
        select: List[str] | None = None,
    ) -> ArvadosAPIRequest[Collection]: ...
    def delete(self, *, uuid: str) -> ArvadosAPIRequest[Collection]: ...
    def get(
        self, *, uuid: str, include_trash: bool = False, select: List[str] | None = None
    ) -> ArvadosAPIRequest[Collection]: ...
    def list(
        self,
        *,
        ...
        select: List[str] | None = None,
        where: dict[str, Any] | None = None,
    ) -> ArvadosAPIRequest[CollectionList]: ...
...
class ComputedPermissions:
    def list(
        ...
        *,
        ...
        select: List[str] | None = None,
        where: dict[str, Any] | None = None,
    ) -> ArvadosAPIRequest[ComputedPermissionList]: ...
...
class ContainerRequests:
    ...
    def create(
        self,
        *,
        body: dict[Literal["container_request"], ContainerRequest],
        cluster_id: str | None = None,
        ensure_unique_name: bool = False,
        select: List[str] | None = None,
    ) -> ArvadosAPIRequest[ContainerRequest]: ...
    ...
    def list(
        ...
        *,
        ...
        select: List[str] | None = None,
        where: dict[str, Any] | None = None,
    ) -> ArvadosAPIRequest[ContainerRequestList]: ...
    def update(
        self,
        *,
        body: dict[Literal["container_request"], ContainerRequest],
...
class Containers:
    ...
    def create(
        self,
        *,
        body: dict[Literal["container"], Container],
        cluster_id: str | None = None,
        ensure_unique_name: bool = False,
        select: List[str] | None = None,
    ) -> ArvadosAPIRequest[Container]: ...
    ...
    def list(
        ...
        *,
        ...
        select: List[str] | None = None,
        where: dict[str, Any] | None = None,
    ) -> ArvadosAPIRequest[ContainerList]: ...
...
class Groups:
    def contents(
        ...
        *,
        ...
        count: str = "exact",
        distinct: bool = False,
        exclude_home_project: bool = False,
        filters: List[str] | None = None,
        ...
        uuid: str = "",
        where: dict[str, Any] | None = None,
    ) -> ArvadosAPIRequest[Group]: ...
    def create(
        self,
        *,
        body: dict[Literal["group"], Group],
        async_: bool = False,
        cluster_id: str | None = None,
        ensure_unique_name: bool = False,
        select: List[str] | None = None,
...
class KeepServices:
    ...
    def create(
        self,
        *,
        body: dict[Literal["keep_service"], KeepService],
        cluster_id: str | None = None,
        ensure_unique_name: bool = False,
        select: List[str] | None = None,
    ) -> ArvadosAPIRequest[KeepService]: ...
    ...
    def list(
        ...
        *,
        ...
        select: List[str] | None = None,
        where: dict[str, Any] | None = None,
    ) -> ArvadosAPIRequest[KeepServiceList]: ...
    def update(
        self,
        *,
        body: dict[Literal["keep_service"], KeepService],
...
class Links:
    def create(
        self,
        *,
        body: dict[Literal["link"], Link],
        cluster_id: str | None = None,
        ensure_unique_name: bool = False,
        select: List[str] | None = None,
    ) -> ArvadosAPIRequest[Link]: ...
...
class Logs:
    def create(
        self,
        *,
        body: dict[Literal["log"], Log],
        cluster_id: str | None = None,
        ensure_unique_name: bool = False,
        select: List[str] | None = None,
    ) -> ArvadosAPIRequest[Log]: ...
...
class UserAgreements:
    def create(
        self,
        *,
        body: dict[Literal["user_agreement"], UserAgreement],
        cluster_id: str | None = None,
        ensure_unique_name: bool = False,
        select: List[str] | None = None,
    ) -> ArvadosAPIRequest[UserAgreement]: ...
    ...
    def list(
        ...
        *,
        ...
        select: List[str] | None = None,
        where: dict[str, Any] | None = None,
    ) -> ArvadosAPIRequest[UserAgreementList]: ...
...
class Users:
    ...
    def create(
        self,
        *,
        body: dict[Literal["user"], User],
        cluster_id: str | None = None,
        ensure_unique_name: bool = False,
        select: List[str] | None = None,
    ) -> ArvadosAPIRequest[User]: ...
    ...
    def list(
        ...
        *,
        ...
        select: List[str] | None = None,
        where: dict[str, Any] | None = None,
    ) -> ArvadosAPIRequest[UserList]: ...
    def merge(
        self,
        *,
        new_owner_uuid: str,
        new_user_token: str | None = None,
        new_user_uuid: str | None = None,
        old_user_uuid: str | None = None,
        redirect_to_new_user: bool = False,
    ) -> ArvadosAPIRequest[User]: ...
    def setup(
        self,
        *,
...
class VirtualMachines:
    def create(
        self,
        *,
        body: dict[Literal["virtual_machine"], VirtualMachine],
        cluster_id: str | None = None,
        ensure_unique_name: bool = False,
        select: List[str] | None = None,
    ) -> ArvadosAPIRequest[VirtualMachine]: ...
    ...
    def list(
        ...
        *,
        ...
        select: List[str] | None = None,
        where: dict[str, Any] | None = None,
    ) -> ArvadosAPIRequest[VirtualMachineList]: ...
...
class Workflows:
    def create(
        self,
        *,
        body: dict[Literal["workflow"], Workflow],
        cluster_id: str | None = None,
        ensure_unique_name: bool = False,
        select: List[str] | None = None,
    ) -> ArvadosAPIRequest[Workflow]: ...
    ...
    def list(
        ...
        *,
        ...
        select: List[str] | None = None,
        where: dict[str, Any] | None = None,
    ) -> ArvadosAPIRequest[WorkflowList]: ...
    def update(
        self,
        *,
        body: dict[Literal["workflow"], Workflow],
