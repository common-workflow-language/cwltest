...
from typing import (
    TypeVar, Iterator, Iterable, overload, Text,
...
@overload
def open(file: str, mode: AnyStr = 'r', buffering: int = ...) -> BinaryIO: ...
@overload
def open(file: unicode, mode: AnyStr = 'r', buffering: int = ...) -> BinaryIO: ...
@overload
...
class file(BinaryIO):
    ...
    def writelines(self, data: Iterable[Union[str, Text]]) -> None: ...
